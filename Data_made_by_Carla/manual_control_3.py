...
class SensorManager:
    ...
    def save_rgb_image(self, image):
        ...
        # print()
        cv2.imwrite(f"./bigop/{str(datetime.datetime.now()).replace(':','').replace('.','')}.png",array)
...
def run_simulation(args, client):
    ...
    try:
        ...
        SensorManager(world, display_manager, 'LiDAR', carla.Transform(carla.Location(x=0, z=2.4)), 
                      vehicle, {'channels' : '64', 'range' : '100',  'points_per_second': '560000', 'rotation_frequency': '1000'}, display_pos=[1, 0])
...
def main():
    ...
    argparser.add_argument(
        '--res',
        metavar='WIDTHxvehicle.set_autopilot(True)HEIGHT',
        default='1280x720',
